...
public class ParticleSwarm {
    ...
    void solve() {
        ...
        while (this.epochs < Constants.MAX_ITERATIONS) {
            ...
            for (Particle actualParticle : this.particleSwarm) {
                ...
                if (Constants.function(actualParticle.getPosition()) > Constants.function(actualParticle.getBestPosition())) {
                    actualParticle.setBestPosition(actualParticle.getPosition());
                }

                if (Constants.function(actualParticle.getBestPosition()) > Constants.function(this.globalBestSolution)) {
    ...
    void showSolution() {
        ...
        System.out.println("Value f(x,y)=" + Constants.function(globalBestSolution));
    }
}
